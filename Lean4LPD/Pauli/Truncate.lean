...
because a difference with vanishing coefficients has vanishing `‖·‖_2̄`, hence vanishing entries.
...
`∑_p ‖x_p‖² = ‖O‖_2̄²`, so an operator all of whose coefficients vanish has `‖·‖_2̄ = 0`, hence all
