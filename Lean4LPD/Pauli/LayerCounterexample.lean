...
-- The finite suffix certificate checks 23 symbolic coefficient nodes with exact phase arithmetic.
...
theorem pf2_coeff_polynomial (θ : ℝ) :
  ...
  rw [hseed, htarget]
  let v : EuclideanSpace ℂ (PauliIndex 8) :=
    WithLp.toLp 2 (Pi.single (bitIndex 0 8) (1 : ℂ))
  -- Only the 23 nonzero scalar nodes are expanded. Every omitted branch is proved
  -- zero by the sound backward support test, not by numerical evaluation.
  have h_14_0_8 : (layerAct ((pf2Rotations θ).drop 14) v).ofLp
      (bitIndex 0 8) = 1 := by
    rw [show (pf2Rotations θ).drop 14 = [] by rfl, layerAct]
    exact Pi.single_eq_same (M := fun _ : PauliIndex 8 => ℂ) (bitIndex 0 8) (1 : ℂ)
  have h_13_0_8 : (layerAct ((pf2Rotations θ).drop 13) v).ofLp
      (bitIndex 0 8) = 1 := by
    rw [suffix_coeff_step θ 13 3 v (bitIndex 0 8) (by rfl),
      ite_eq_left (by decide)]
    all_goals exact h_14_0_8
  have h_12_0_8 : (layerAct ((pf2Rotations θ).drop 12) v).ofLp
      (bitIndex 0 8) = 1 := by
    rw [suffix_coeff_step θ 12 2 v (bitIndex 0 8) (by rfl),
      ite_eq_left (by decide)]
    all_goals exact h_13_0_8
  have h_11_12_8 : (layerAct ((pf2Rotations θ).drop 11) v).ofLp
      (bitIndex 12 8) = s := by
    rw [suffix_coeff_step θ 11 1 v (bitIndex 12 8) (by rfl),
      ite_eq_right (by decide)]
    have h_12_12_8 : (layerAct ((pf2Rotations θ).drop 12) v).ofLp
        (bitIndex 12 8) = 0 :=
    ...
    rw [hp, hs, h_12_12_8, h_12_0_8]
    dsimp only [c, s]
    ring
  have h_10_12_8 : (layerAct ((pf2Rotations θ).drop 10) v).ofLp
      (bitIndex 12 8) = s := by
    rw [suffix_coeff_step θ 10 0 v (bitIndex 12 8) (by rfl),
      ite_eq_left (by decide)]
    all_goals exact h_11_12_8
  have h_9_12_8 : (layerAct ((pf2Rotations θ).drop 9) v).ofLp
      (bitIndex 12 8) = s := by
    rw [suffix_coeff_step θ 9 6 v (bitIndex 12 8) (by rfl),
      ite_eq_left (by decide)]
    all_goals exact h_10_12_8
  have h_8_20_8 : (layerAct ((pf2Rotations θ).drop 8) v).ofLp
      (bitIndex 20 8) = -s ^ 2 := by
    rw [suffix_coeff_step θ 8 5 v (bitIndex 20 8) (by rfl),
      ite_eq_right (by decide)]
    have h_9_20_8 : (layerAct ((pf2Rotations θ).drop 9) v).ofLp
        (bitIndex 20 8) = 0 :=
    ...
    rw [hp, hs, h_9_20_8, h_9_12_8]
    dsimp only [c, s]
    ring
  have h_8_12_8 : (layerAct ((pf2Rotations θ).drop 8) v).ofLp
      (bitIndex 12 8) = c * s := by
    rw [suffix_coeff_step θ 8 5 v (bitIndex 12 8) (by rfl),
      ite_eq_right (by decide)]
    have h_9_20_8 : (layerAct ((pf2Rotations θ).drop 9) v).ofLp
        (bitIndex 20 8) = 0 :=
      coeff_zero_of_not_backward ((L₁ ++ L₂ ++ L₂ ++ L₁).drop 9) θ
    ...
    have hs : partnerSign (generator 5) (bitIndex 12 8) = (-1 : ℂ) := by
      ...
      all_goals exact iPow_two
    rw [hp, hs, h_9_12_8, h_9_20_8]
    dsimp only [c, s]
    ring
  have h_7_22_12 : (layerAct ((pf2Rotations θ).drop 7) v).ofLp
      (bitIndex 22 12) = s ^ 3 := by
    rw [suffix_coeff_step θ 7 4 v (bitIndex 22 12) (by rfl),
      ite_eq_right (by decide)]
    have h_8_22_12 : (layerAct ((pf2Rotations θ).drop 8) v).ofLp
        (bitIndex 22 12) = 0 :=
    ...
    have hs : partnerSign (generator 4) (bitIndex 22 12) = (1 : ℂ) := by
      ...
      all_goals exact iPow_zero
    rw [hp, hs, h_8_22_12, h_8_20_8]
    dsimp only [c, s]
    ring
  have h_7_20_8 : (layerAct ((pf2Rotations θ).drop 7) v).ofLp
      (bitIndex 20 8) = -c * s ^ 2 := by
    rw [suffix_coeff_step θ 7 4 v (bitIndex 20 8) (by rfl),
      ite_eq_right (by decide)]
    have h_8_22_12 : (layerAct ((pf2Rotations θ).drop 8) v).ofLp
        (bitIndex 22 12) = 0 :=
      coeff_zero_of_not_backward ((L₁ ++ L₂ ++ L₂ ++ L₁).drop 8) θ
    ...
    have hs : partnerSign (generator 4) (bitIndex 20 8) = (-1 : ℂ) := by
      ...
      all_goals exact iPow_two
    rw [hp, hs, h_8_20_8, h_8_22_12]
    dsimp only [c, s]
    ring
  have h_7_14_12 : (layerAct ((pf2Rotations θ).drop 7) v).ofLp
      (bitIndex 14 12) = c * s ^ 2 := by
    rw [suffix_coeff_step θ 7 4 v (bitIndex 14 12) (by rfl),
      ite_eq_right (by decide)]
    have h_8_14_12 : (layerAct ((pf2Rotations θ).drop 8) v).ofLp
        (bitIndex 14 12) = 0 :=
      coeff_zero_of_not_backward ((L₁ ++ L₂ ++ L₂ ++ L₁).drop 8) θ
    ...
    have hs : partnerSign (generator 4) (bitIndex 14 12) = (-1 : ℂ) := by
      ...
      all_goals exact iPow_two
    rw [hp, hs, h_8_14_12, h_8_12_8]
    dsimp only [c, s]
    ring
  have h_7_12_8 : (layerAct ((pf2Rotations θ).drop 7) v).ofLp
      (bitIndex 12 8) = c ^ 2 * s := by
    rw [suffix_coeff_step θ 7 4 v (bitIndex 12 8) (by rfl),
      ite_eq_right (by decide)]
    have h_8_14_12 : (layerAct ((pf2Rotations θ).drop 8) v).ofLp
        (bitIndex 14 12) = 0 :=
      coeff_zero_of_not_backward ((L₁ ++ L₂ ++ L₂ ++ L₁).drop 8) θ
    ...
    have hs : partnerSign (generator 4) (bitIndex 12 8) = (1 : ℂ) := by
      ...
      all_goals exact iPow_zero
    rw [hp, hs, h_8_12_8, h_8_14_12]
    dsimp only [c, s]
    ring
  have h_6_22_12 : (layerAct ((pf2Rotations θ).drop 6) v).ofLp
      (bitIndex 22 12) = s ^ 3 := by
    rw [suffix_coeff_step θ 6 6 v (bitIndex 22 12) (by rfl),
      ite_eq_left (by decide)]
    all_goals exact h_7_22_12
  have h_6_20_8 : (layerAct ((pf2Rotations θ).drop 6) v).ofLp
      (bitIndex 20 8) = -c * s ^ 2 := by
    rw [suffix_coeff_step θ 6 6 v (bitIndex 20 8) (by rfl),
      ite_eq_left (by decide)]
    all_goals exact h_7_20_8
  have h_6_14_12 : (layerAct ((pf2Rotations θ).drop 6) v).ofLp
      (bitIndex 14 12) = c * s ^ 2 := by
    rw [suffix_coeff_step θ 6 6 v (bitIndex 14 12) (by rfl),
      ite_eq_left (by decide)]
    all_goals exact h_7_14_12
  have h_6_12_8 : (layerAct ((pf2Rotations θ).drop 6) v).ofLp
      (bitIndex 12 8) = c ^ 2 * s := by
    rw [suffix_coeff_step θ 6 6 v (bitIndex 12 8) (by rfl),
      ite_eq_left (by decide)]
    all_goals exact h_7_12_8
  have h_5_22_12 : (layerAct ((pf2Rotations θ).drop 5) v).ofLp
      (bitIndex 22 12) = 2 * c * s ^ 3 := by
    rw [suffix_coeff_step θ 5 5 v (bitIndex 22 12) (by rfl),
      ite_eq_right (by decide)]
    ...
    have hs : partnerSign (generator 5) (bitIndex 22 12) = (-1 : ℂ) := by
      ...
      all_goals exact iPow_two
    rw [hp, hs, h_6_22_12, h_6_14_12]
    dsimp only [c, s]
    ring
  have h_5_20_8 : (layerAct ((pf2Rotations θ).drop 5) v).ofLp
      (bitIndex 20 8) = -2 * c ^ 2 * s ^ 2 := by
    rw [suffix_coeff_step θ 5 5 v (bitIndex 20 8) (by rfl),
      ite_eq_right (by decide)]
    have hp : partner (generator 5) (bitIndex 20 8) = bitIndex 12 8 := by decide
    have hs : partnerSign (generator 5) (bitIndex 20 8) = (1 : ℂ) := by
      rw [partnerSign, show
        (phaseMul 1 ((generator 5) * herm (bitIndex 20 8))).phase
          - (herm (partner (generator 5) (bitIndex 20 8))).phase = 0 by decide]
      all_goals exact iPow_zero
    rw [hp, hs, h_6_20_8, h_6_12_8]
    dsimp only [c, s]
    ring
  have h_4_22_12 : (layerAct ((pf2Rotations θ).drop 4) v).ofLp
      (bitIndex 22 12) = 4 * c ^ 2 * s ^ 3 := by
    rw [suffix_coeff_step θ 4 4 v (bitIndex 22 12) (by rfl),
      ite_eq_right (by decide)]
    have hp : partner (generator 4) (bitIndex 22 12) = bitIndex 20 8 := by decide
    have hs : partnerSign (generator 4) (bitIndex 22 12) = (1 : ℂ) := by
      rw [partnerSign, show
        (phaseMul 1 ((generator 4) * herm (bitIndex 22 12))).phase
          - (herm (partner (generator 4) (bitIndex 22 12))).phase = 0 by decide]
      all_goals exact iPow_zero
    rw [hp, hs, h_5_22_12, h_5_20_8]
    dsimp only [c, s]
    ring
  have h_3_22_12 : (layerAct ((pf2Rotations θ).drop 3) v).ofLp
      (bitIndex 22 12) = 4 * c ^ 2 * s ^ 3 := by
    rw [suffix_coeff_step θ 3 3 v (bitIndex 22 12) (by rfl),
      ite_eq_left (by decide)]
    all_goals exact h_4_22_12
  have h_2_54_28 : (layerAct ((pf2Rotations θ).drop 2) v).ofLp
      (bitIndex 54 28) = 4 * c ^ 2 * s ^ 4 := by
    rw [suffix_coeff_step θ 2 2 v (bitIndex 54 28) (by rfl),
      ite_eq_right (by decide)]
    have h_3_54_28 : (layerAct ((pf2Rotations θ).drop 3) v).ofLp
        (bitIndex 54 28) = 0 :=
    ...
    have hs : partnerSign (generator 2) (bitIndex 54 28) = (-1 : ℂ) := by
      ...
      all_goals exact iPow_two
    rw [hp, hs, h_3_54_28, h_3_22_12]
    dsimp only [c, s]
    ring
  have h_1_54_28 : (layerAct ((pf2Rotations θ).drop 1) v).ofLp
      (bitIndex 54 28) = 4 * c ^ 2 * s ^ 4 := by
    rw [suffix_coeff_step θ 1 1 v (bitIndex 54 28) (by rfl),
      ite_eq_left (by decide)]
    all_goals exact h_2_54_28
  have h_0_55_30 : (layerAct ((pf2Rotations θ).drop 0) v).ofLp
      (bitIndex 55 30) = -4 * c ^ 2 * s ^ 5 := by
    rw [suffix_coeff_step θ 0 0 v (bitIndex 55 30) (by rfl),
      ite_eq_right (by decide)]
    have h_1_55_30 : (layerAct ((pf2Rotations θ).drop 1) v).ofLp
        (bitIndex 55 30) = 0 :=
    ...
    have hs : partnerSign (generator 0) (bitIndex 55 30) = (1 : ℂ) := by
      ...
      all_goals exact iPow_zero
    rw [hp, hs, h_1_55_30, h_1_54_28]
    dsimp only [c, s]
    ring
  simpa only [List.drop_zero, c, s] using h_0_55_30
